...
class ReverseNormConvolutionalProcessingBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(NormConvolutionalProcessingBlock, self).__init__()
...
class BothNormConvolutionalProcessingBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(NormConvolutionalProcessingBlock, self).__init__()
...
class NormConvolutionalDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(NormConvolutionalDimensionalityReductionBlock, self).__init__()
...
class ReverseNormConvolutionalDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(NormConvolutionalDimensionalityReductionBlock, self).__init__()
...
class BothNormConvolutionalDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(NormConvolutionalDimensionalityReductionBlock, self).__init__()
